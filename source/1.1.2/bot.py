...
"""開機訊息"""
bot_m = '[Bot]'
cmd_message1 = ">> SmileGuy Running! V1.1.2(2019/08/26)"
...
async def on_ready():
    #終端訊息
    await bot.change_presence(status=discord.Status.idle,activity=discord.Game('SmileGuy Running! V1.1.2')) #bot狀態
...
async def on_guild_join(guild):
    ...
    embed.add_field(name="目前版本", value="1.1.2(20190826)", inline=True)
