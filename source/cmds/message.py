...
class message(Cog_Extension):
    ...
    async def on_message(self, msg):
        ...
        elif msg.content == 'e04' and msg.author != self.bot.user and msg.guild.id != 534366668076613632 : # 幹你娘
            embed = discord.Embed(color=0xffd300)
        ...
        elif msg.content == '早' and msg.author != self.bot.user and msg.guild.id != 534366668076613632 : # 早安
            ramdom_mes = random.choice(jdata_in[f'chat_mes_morning'])
            await msg.channel.send(f"{msg.author.mention} {ramdom_mes}")
            
        elif msg.content == '喔' and msg.author != self.bot.user and msg.guild.id != 534366668076613632 : # 喔
            embed = discord.Embed(color=0xffd300)
