...
class smile(Cog_Extension):
    ...
    async def on_guild_join(self,guild):
        ...
        embed=discord.Embed(title="我的原始碼", url="https://github.com/minexo79/SmileGuy",color=embedconfig.color)
    ...
    async def about(self,ctx):
        embed1=discord.Embed(title="我的原始碼", url="https://github.com/minexo79/SmileGuy",color=embedconfig.color)
